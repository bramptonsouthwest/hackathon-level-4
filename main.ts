...
sprites.onCreated(SpriteKind.Projectile, function (sprite) {
    ...
    sprite.startEffect(effects.warmRadial, 2000)
})
...
info.setLife(3)
info.setScore(0)
game.splash("Dracula won't let you ", "escape that easily...")
...
player1.setPosition(74, 65)
controller.moveSprite(player1)
let super_sword = sprites.create(img`
    . . . . . . 2 2 2 . . . . . . . 
    . . . . . . 2 1 2 . . . . . . . 
    . . . . . . 2 1 2 . . . . . . . 
    . . . . . . 2 1 2 . . . . . . . 
    . . . . . . 2 1 2 . . . . . . . 
    . . . . . 2 3 1 3 2 . . . . . . 
    3 3 3 3 2 3 1 1 1 3 2 3 3 3 3 3 
...
dracula = sprites.create(img`
    ...
    ....................
    `, SpriteKind.Boss)
dracula.setBounceOnWall(true)
dracula.setPosition(15, 22)
forever(function () {
    pause(2000)
    if (Math.percentChance(50)) {
        dracula.setPosition(15, 25)
        ...
        dracula.setVelocity(randint(20, 70), randint(20, 70))
        for (let index = 0; index < 4; index++) {
            bat = sprites.createProjectileFromSprite(img`
                . . f f f . . . . . . . . . . . 
                f f f c c . . . . . . . . f f f 
        ...
        pause(5000)
        dracula.setVelocity(0, 0)
    } else if (Math.percentChance(50)) {
        dracula.setPosition(119, 87)
        for (let index = 0; index < 4; index++) {
            bat = sprites.createProjectileFromSprite(img`
                . . f f f . . . . . . . . . . . 
                f f f c c . . . . . . . . f f f 
